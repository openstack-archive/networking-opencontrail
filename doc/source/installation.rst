...
You can also specify the branch (supported branches can be checked here https://git.openstack.org/cgit/openstack/networking-opencontrail/refs/ )::

    $ pip install \
      -c https://git.openstack.org/cgit/openstack/requirements/plain/upper-constraints.txt?h=stable/ocata
      -e git+https://git.openstack.org/openstack/networking-opencontrail@stable/ocata#egg=networking-opencontrail
