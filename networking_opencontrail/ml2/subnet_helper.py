...
class SubnetSynchronizeHelper(object):
    ...
    def before_delete_subnet(self, resource, event, trigger, **kwargs):
        subnet_id = kwargs.get('subnet_id')
        context = kwargs.get('context')

        try:
            self._delete_tf_dns_ports(context, subnet_id)
        except Exception:
    ...
    def _get_tf_dns_in_neutron(self, context, subnet_id):
    ...
    def _delete_tf_dns_ports(self, context, subnet_id):
        dns_ports = self._get_tf_dns_in_neutron(context, subnet_id)
