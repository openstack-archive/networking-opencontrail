...
class L3OpenContrailTestCases(test_extensions_base.ExtensionTestCase):
    ...
    @mock.patch("networking_opencontrail.l3.tungstenfabric_api."
                "TungstenFabricApiConnector")
    @mock.patch("networking_opencontrail.drivers.drv_opencontrail."
                "OpenContrailDrivers")
    def test_get_plugin_type(self, _, tf_api):
    ...
    @mock.patch("networking_opencontrail.drivers.drv_opencontrail."
                "OpenContrailDrivers")
    def test_get_plugin_description(self, _, tf_api):
        hook = opencontrail_rt_callback.OpenContrailRouterHandler()
    ...
    def test_create_router(self, l3_nat, driver, tf_api):
    ...
    def test_delete_router(self, l3_nat, driver, tf_api):
    ...
    def test_update_router(self, extra_route, driver, tf_api):
        router_id, router = self._get_router_test()
        context = get_mock_network_operation_context()
        hook = opencontrail_rt_callback.OpenContrailRouterHandler()
    ...
    def test_add_router_interface(self, l3_nat, driver, tf_api):
        router_id, _ = self._get_router_test()
    ...
    def test_remove_router_interface(self, l3_nat, driver, tf_api):
        router_id, _ = self._get_router_test()
        interface_info = self._get_interface_info()
        context = get_mock_network_operation_context()
        hook = opencontrail_rt_callback.OpenContrailRouterHandler()
    ...
    @mock.patch("neutron.db.l3_dvr_db.L3_NAT_with_dvr_db_mixin."
                "create_floatingip")
    def test_create_floatingip(self, l3_nat, driver, tf_api):
        context = get_mock_network_operation_context()
    ...
    def test_update_floatingip(self, l3_nat, l3_get, _, driver, tf_api):
        context = get_mock_network_operation_context()
        floatingip = self._get_floating_ip()
        l3_nat.return_value = floatingip
    ...
    @mock.patch("neutron.db.l3_dvr_db.L3_NAT_with_dvr_db_mixin."
                "delete_floatingip")
    def test_delete_floatingip(self, l3_nat, l3_get, driver, tf_api):
        context = get_mock_network_operation_context()
        floatingip = self._get_floating_ip()
        l3_nat.return_value = floatingip
        l3_get.return_value = floatingip['floatingip']
